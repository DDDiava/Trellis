...
`implement.jsonl` and `check.jsonl` are seeded by `task.py create`. Curate real context entries from the code-spec files and research found by the Research Agent:
