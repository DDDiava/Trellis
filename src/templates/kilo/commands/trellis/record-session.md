...
- [OK] Auto-detects line count, creates new file if exceeds `max_journal_lines` (default 2000)
- [OK] Updates index.md (Total Sessions +1, Last Active, line stats, history)
- [OK] Auto-commits workspace changes (uses `session_commit_message` from config.yaml, default `chore: record journal`)
