...
const FALLBACK_BREADCRUMBS = {
  ...
  in_progress:
    ...
    "user did not say.",
  completed:
    "Code should already be committed via Phase 3.4 and handed off through PR review. " +
    "If the PR is not merged yet, sync/review/finish the PR and wait for human review; " +
    "do not archive. After the user merges or confirms local-only completion, run " +
    "post-merge reconcile first, then archive and journal only after the local base " +
